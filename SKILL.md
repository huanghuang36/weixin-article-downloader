...
python /Users/wuweifang/work_sp/learning_weixin/.worktrees/feat-weixin-downloader/learning_weixin/skills/weixin-article-downloader/tool/main.py "<ARTICLE_URL>" [-o ./output]

# Browser mode (bypasses anti-crawl, recommended)
python /Users/wuweifang/work_sp/learning_weixin/.worktrees/feat-weixin-downloader/learning_weixin/skills/weixin-article-downloader/tool/main.py "<ARTICLE_URL>" --browser
```
...
python /Users/wuweifang/work_sp/learning_weixin/.worktrees/feat-weixin-downloader/learning_weixin/skills/weixin-article-downloader/tool/main.py "https://mp.weixin.qq.com/s?__biz=..." --browser -o ./articles/
```
...
```bash
bash /Users/wuweifang/work_sp/learning_weixin/.worktrees/feat-weixin-downloader/learning_weixin/skills/weixin-article-downloader/install.sh
```
